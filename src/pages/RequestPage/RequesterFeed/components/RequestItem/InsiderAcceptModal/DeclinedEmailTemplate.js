  ...
  ">
       <tr>
        ...
        >
          <p>Hi ${target},</p>
          <p>
          We would like to inform you that ${sender} appears to no longer need help with their <b>${services}</b> request. Their request will be removed from your feed and we appreciate your offer to help.
